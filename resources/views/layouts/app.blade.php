...
<body class="antialiased font-sans bg-gray-200">
    <div class="min-h-full">
        <header class="pb-24 bg-indigo-600" x-data="{ open: false, focus: true }" @keydown.escape="open = false">
                        ...
                        <div x-data="{ open: false }" @keydown.escape.stop="open = false" @click.away="open = false"
                            ...
                            <div>
                                <button type="button"
                                    ...
                                    id="user-menu-button" x-ref="button" @click="open = true" aria-expanded="false"
                            ...
                            <div x-show="open" x-transition:leave="transition ease-in duration-75"
                                ...
                                <x-responsive-nav-link :href="route('profile.edit')" class="block px-4 py-2 text-sm text-gray-700">
                                    {{ __('Profile') }}
        ...
        <footer>
            <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 lg:max-w-7xl">
                <div class="border-t border-gray-200 py-8 text-sm text-gray-500 text-center sm:text-left"><span
                        class="block sm:inline">© 2021 Tailwind Labs Inc.</span> <span class="block sm:inline">All
